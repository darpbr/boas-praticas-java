...
public class AdopetConsoleApplication {
	...
	private static void cadastratAbrigo() throws IOException, InterruptedException {
	...
	private static HttpResponse<String> dispararRequisicaoGet(String uri, HttpClient client)
	...
	private static HttpResponse<String> dispararRequisicaoPost(String uri, HttpClient client, JsonObject json)
			throws IOException, InterruptedException {
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(uri))
